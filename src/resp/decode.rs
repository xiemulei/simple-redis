...
use crate::{
    ...
    RespNullBulkString, RespSet,
};

use super::{
    calc_total_length, extract_simple_frame_data, parse_length, RespArray, SimpleError,
...
impl RespDecode for BulkString {
    ...
    fn decode(buf: &mut BytesMut) -> Result<Self, RespError> {
        ...
        let reminded = &buf[end + CRLF_LEN..];
        if reminded.len() < len + CRLF_LEN {
